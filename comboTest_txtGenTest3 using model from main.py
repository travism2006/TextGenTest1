...
"""
    TEST https://towardsdatascience.com/how-our-device-thinks-e1f5ab15071e


    Running with model from  "main"
"""
...
history = model.fit(xs, ys, epochs=100, verbose=1) #training for 500 epochs = original
